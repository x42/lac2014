...
### Note during conference about streaming and IRC ###
    ...
    echo '<div>Direct link to video stream: <a href="http://lacstreamer.stackingdwarves.net/lac2014.ogg" rel="external">http://lacstreamer.stackingdwarves.net/lac2014.ogg</a>. The A/V is provided in Ogg/Theora/Vorbis (plays in firefox, chrom[e|ium]). Should you have problems playing these, consult Wikipedia\'s <a href="http://en.wikipedia.org/wiki/Wikipedia:Media_help_%28Ogg%29" rel="external">OGG media help.</a></div>';
